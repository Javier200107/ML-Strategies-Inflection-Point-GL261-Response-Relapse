...
The DL approach achieved the highest overall performance, obtaining an AUC of 0.8511 compared with \textcolor{red}{0.770 (95\% CI 0.703--0.832)} for the radiomics pipeline. Improvements were observed across \textcolor{red}{most} evaluation metrics, particularly sensitivity: in the fine-tuned EfficientNet configuration, \textcolor{red}{90.9\% of cured \textbf{examinations}} were correctly identified, compared with \textcolor{red}{54.6\%} for XGBoost. \textcolor{red}{All metrics reported in Table~\ref{tab:all_models} are computed at the level of individual MRI examinations (exam-level); subject-level (animal-level) metrics are discussed below.}
...
J.G.: \textcolor{red}{conceptualization,} methodology, software, formal analysis, investigation, data curation, visualization, and writing of the original draft.\newline
