...
class TFRecordDataHandlerDL:
    ...
    def _parse_function(self, proto):
        ...
        return image, mask, parsed_features['group_name'][tf.newaxis], parsed_features['mouse_id'][tf.newaxis], parsed_features['day_of_study'][tf.newaxis]
    ...
    def _augment(self, image, mask): # self, image, mask, group_name, mouse_id, day_of_study
