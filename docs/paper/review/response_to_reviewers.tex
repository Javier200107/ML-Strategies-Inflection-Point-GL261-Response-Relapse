...
\toprule
Model & AUC {[}95\% CI{]} & Sensitivity {[}95\% CI{]} & Specificity {[}95\% CI{]} & PPV {[}95\% CI{]} & Accuracy {[}95\% CI{]} \\
\midrule
Radiomics   & 0.770 {[}0.703, 0.832{]} & 0.545 {[}0.421, 0.667{]} & 0.806 {[}0.755, 0.856{]} & 0.444 {[}0.338, 0.554{]} & 0.748 {[}0.698, 0.799{]} \\
Eff.\ FE+XGB & 0.801 {[}0.731, 0.864{]} & 0.606 {[}0.486, 0.720{]} & 0.853 {[}0.806, 0.898{]} & 0.541 {[}0.425, 0.653{]} & 0.799 {[}0.752, 0.842{]} \\
Eff.\ FT    & 0.868 {[}0.810, 0.918{]} & 0.818 {[}0.717, 0.907{]} & 0.759 {[}0.702, 0.812{]} & 0.491 {[}0.397, 0.583{]} & 0.772 {[}0.721, 0.819{]} \\
\bottomrule
\end{tabular}
\end{table}
